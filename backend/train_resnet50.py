...
用法: python train_resnet50.py --data_dir <数据集路径>
"""
import os
import time
import argparse
...
# 配置
# ============================================================
parser = argparse.ArgumentParser(description="组员2 - ResNet50 车型识别训练")
...
parser.add_argument("--output_name", default="resnet50")
...
def main():
    ...
    print(f"[组员2 - ResNet50] Device: {device}")
